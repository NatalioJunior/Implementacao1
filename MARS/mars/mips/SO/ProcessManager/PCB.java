...
public class PCB {
	...
	private int limite_Superior;	//Registrador de limite superior da mem�ria do processo
	private int limite_Inferior;	//Registrador de limite inferior da mem�ria do processo
	...
	public PCB(int pID){ //usado no escalonamento por prioridade
		this.PID = pID;
	}
